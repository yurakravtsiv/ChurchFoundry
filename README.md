...
- **Налаштування** — сторінка з вертикальними табами: профіль **церкви** (назва, адреса з пошуком, телефон, email, логотип), довідники інвентаря (категорії / підкатегорії / локації / відповідальні) і генерація тестових даних
