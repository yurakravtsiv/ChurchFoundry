...
- **Інвентар** (повний модуль):
  - CRUD предметів
  - категорії / підкатегорії / локації зі створенням «на льоту» та CRUD на сторінці **Налаштування** (вертикальні таби)
...
- **Налаштування** — сторінка з вертикальними табами: профіль **церкви** (назва, адреса з пошуком, телефон, email, логотип), довідники інвентаря (категорії / підкатегорії / локації) і генерація тестових даних
- **Брендинг церкви** — якщо задані назва і логотип, вони показуються в хедері; неавторизований скан QR відкриває картку церкви з можливістю увійти
