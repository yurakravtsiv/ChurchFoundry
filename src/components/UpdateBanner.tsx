...
export function UpdateBanner() {
  ...
  return (
    <div
      className={cn(
        "pointer-events-none fixed inset-x-0 bottom-0 z-[60] flex justify-center bg-background px-4 pb-[max(1rem,env(safe-area-inset-bottom,0px))] transition-all duration-300 ease-out",
