  ...
  return (
    ...
    >
      <SelectTrigger
        ...
        className={cn(
          "relative z-10 h-8 w-fit gap-1 px-2 text-sm font-medium shadow-none focus:ring-0 focus:ring-offset-0",
          className,
        )}
      >
      ...
      <SelectContent
        position="popper"
        className="z-[80] max-h-60 min-w-[var(--radix-select-trigger-width)]"
      >
        {options?.map((option) => (
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav: cn(
          // Nav spans the caption row; let clicks through to month/year selects.
